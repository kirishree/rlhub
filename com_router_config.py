...
def main():
    ...
    config_commands = [
        ...
        "configure terminal",
            "ip route {dialerserverip} 255.255.255.255 {interface_wan_gateway}",
            "end",
        ...
        "configure terminal",
            ...
            "vpdn-group reachlink",
                ...
                "protocol pptp",
                "pool-member 1",
                "initiate-to ip {dialerserverip}",
                "end",

        "configure terminal",
            "interface Dialer1",
                "ip address {dialer_client_ip} {dialer_netmask}",
                "ip mtu 1412",
                "encapsulation ppp",
                ...
                "ppp pap sent-username {dialer_username} password {dialer_password}",
                "end",   
        ...
        "configure terminal",
            ...
            "snmp-server host {ubuntu_dialerclient_ip} version 2c {snmpcommunitystring}",
