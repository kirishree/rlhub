...
os.system("cp hub_config.py /etc/reach/reachlink/reachlinkst.py")
os.system("cp urls_new.py /etc/reach/reachlink/reachlink/urls.py")
#os.system("cp conf/dist/robustel_conf.exe /etc/reach/reachlink/")
os.system("cp reachlink_zabbix.py /etc/reach/reachlink/")
os.system("cp conf/dist/reachlink_cisco_config.exe /etc/reach/reachlink/")
