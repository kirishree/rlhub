...
from reach.views import get_m2mspoke_config, get_firewall_filter_details_spoke, get_firewall_nat_details_spoke, get_blocked_app_details_spoke, add_app_spoke, add_firewall_filter_spoke
urlpatterns = [  
