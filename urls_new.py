...
from reach.views import login_or_register, change_password
urlpatterns = [
    ...
    path('interface_config_e', interface_config_spoke, name='interface_config_spoke'),
    path('vlan_interface_delespokte_spoke', vlan_interface_delete_spoke, name='vlan_interface_delete_spoke'),
